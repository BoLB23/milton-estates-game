...
# The CI workflow targets this stage after building and testing `dist` in its
# read-only package-permission job. This keeps the publish-capable token out of
# the Docker build. A direct `docker build` still uses the reproducible build
# stage below.
