...
- Review assets: `docs/assets/phase-a/`; the live fold-out map remains at `public/assets/concepts/phase-a/`. Supporting review notes: `docs/archive/phase-a-visual-targets.md`.
